...
"}"));
        ...
        lineEdit->setGeometry(QRect(290, 40, 221, 21));
...
"	background-color: rgb(230, 255, 230)\n"
"}"));
        colButton = new QPushButton(Search);
        colButton->setObjectName(QStringLiteral("colButton"));
        colButton->setGeometry(QRect(520, 40, 21, 21));
    ...
    void retranslateUi(QWidget *Search)
    {
        ...
        colButton->setText(QApplication::translate("Search", "col", Q_NULLPTR));
    } // retranslateUi
